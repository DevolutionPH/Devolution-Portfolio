    ...
    <div className='flex justify-between items-center gap-3 mx-auto max-w-7xl py-40'>
        <div className='w-1/2'>
            <div className='flex justify-center flex-col items-center'>
                ...
                <p className='text-gray-400 text-sm leading-loose'>our forward-thinking strategies and client-centric approach, our award-winning modern business solutions agency consistently delivers transformative results that propel our clients towards success in today's dynamic market landscape.</p>

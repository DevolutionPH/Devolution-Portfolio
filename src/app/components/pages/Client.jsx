...
const Client = () => {
  return (
    <div className='flex flex-col justify-between items-center gap-3 mx-auto max-w-7xl pt-20 pb-40 px-5 relative'>
        <Image alt='emoji1' src={emojiBg} className='absolute top-[20%] -left-32 max-2xl:left-0 max-w-56'/>
        <Image alt='emoji2' src={emojiBg2} className='absolute top-[25%] -right-36 max-w-64 max-2xl:right-0'/>
        ...
        <div className='flex items-center justify-between gap-5'>
            <div className='flex flex-col justify-start w-[45%] gray-custom-bg p-10 gap-5'>
